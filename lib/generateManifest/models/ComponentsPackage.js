class ComponentsPackage {
    ...
    createControl(declaration) {
        ...
        while (declaration) {
            interfaces = [...interfaces, ...currentPackage.getInterfacesForDeclaration(declaration)];
            properties = [...properties, ...currentPackage.getPropertiesForDeclaration(declaration)];
            aggregations = [...aggregations, ...currentPackage.getAggregationsForDeclaration(declaration)];
            associations = [...associations, ...currentPackage.getAssociationsForDeclaration(declaration)];
