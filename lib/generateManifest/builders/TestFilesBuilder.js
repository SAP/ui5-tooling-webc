...
const ControlInstanceBuilder = require("./ControlInstanceBuilder");

class TestFilesBuilder {
	constructor(control, canUseMainButton) {
		this.control = control;

        const instanceBuilder = new ControlInstanceBuilder(this.control, canUseMainButton, 1);
    ...
    generateTestPage() {
		...
		<head>
			<meta charset="utf-8">
			<title>${this.control.basename} - ${this.control.library}</title>
